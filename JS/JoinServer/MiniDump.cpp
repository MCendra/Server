...
// Función de filtro para el manejo de excepciones y generación de minidumps
LONG WINAPI DumpExceptionFilter(EXCEPTION_POINTERS* info)
{
    ...
    // Creación del archivo de minidump
    ...
    // Si el archivo no se creó o falló la escritura del minidump
