...
void CServerInfo::ReadCustomInfo()
{
...
#endif
#if(B_HON_HOAN)	
	gBHonHoan.LoadConfig(gPath.GetFullPath("Custom\\HonHoan.xml"));
#endif
#if(B_BUFF_PHE)
	gBBuffPhe.LoadFileXML(gPath.GetFullPath("Custom\\BBuffPhe.xml"));
#endif
	...
	gBCustomSkinModel.Load(gPath.GetFullPath("Custom\\CustomSkinModel.xml"));


#if (GHRS_TOP1_NEW == 1)
	gCustomGHRS.Load(gPath.GetFullPath("Custom\\CustomGHRS.ini"));
#endif
...
#if(DANHHIEU_NEW)
	gDanhHieu.Load();
	gDanhHieu.Load1(gPath.GetFullPath("Custom\\DanhHieu\\DanhHieu.txt"));
...
void CServerInfo::ReadEventInfo()
{
	...
	gBEventEndLess.LoadFileXML(gPath.GetFullPath("Event\\EndLessTower.xml"));
#endif
...
#if(CTCMINI == 1)
	gCTCMini.Load(gPath.GetFullPath("Event\\ChienPhe\\CongThanhChien.xml"));
	gCTCMini.Init();
#endif
...
void CServerInfo::ReadChaosMixInfo(char* section,char* path)
{
	...
	this->m_WingCustomMixRate[0] = GetPrivateProfileInt(section, "WingCustomMixRate_AL0", 0, path);
	this->m_WingCustomMixRate[1] = GetPrivateProfileInt(section, "WingCustomMixRate_AL1", 0, path);
	this->m_WingCustomMixRate[2] = GetPrivateProfileInt(section, "WingCustomMixRate_AL2", 0, path);
	this->m_WingCustomMixRate[3] = GetPrivateProfileInt(section, "WingCustomMixRate_AL3", 0, path);
#endif
	//
#if(CUSTOM_MIX_WING_SEASON13)
	this->m_WingSeason13MixRate[0] = GetPrivateProfileInt(section, "WingSeason13MixRate_AL0", 0, path);
	this->m_WingSeason13MixRate[1] = GetPrivateProfileInt(section, "WingSeason13MixRate_AL1", 0, path);
	this->m_WingSeason13MixRate[2] = GetPrivateProfileInt(section, "WingSeason13MixRate_AL2", 0, path);
	this->m_WingSeason13MixRate[3] = GetPrivateProfileInt(section, "WingSeason13MixRate_AL3", 0, path);
#endif
	//
#if(CUSTOM_MIX_WING_SEASON8)
	this->m_WingSeason8MixRate[0] = GetPrivateProfileInt(section, "WingSeason8MixRate_AL0", 0, path);
	this->m_WingSeason8MixRate[1] = GetPrivateProfileInt(section, "WingSeason8MixRate_AL1", 0, path);
	this->m_WingSeason8MixRate[2] = GetPrivateProfileInt(section, "WingSeason8MixRate_AL2", 0, path);
	this->m_WingSeason8MixRate[3] = GetPrivateProfileInt(section, "WingSeason8MixRate_AL3", 0, path);
#endif

#if(CUSTOM_MIX_WING_VIP)
	this->m_WingVipMixRate[0] = GetPrivateProfileInt(section, "WingVipMixRate_AL0", 0, path);
	this->m_WingVipMixRate[1] = GetPrivateProfileInt(section, "WingVipMixRate_AL1", 0, path);
	this->m_WingVipMixRate[2] = GetPrivateProfileInt(section, "WingVipMixRate_AL2", 0, path);
	this->m_WingVipMixRate[3] = GetPrivateProfileInt(section, "WingVipMixRate_AL3", 0, path);
#endif

#if(CUSTOM_MIX_PET_CAP2)
	this->m_Muun2MixRate[0] = GetPrivateProfileInt(section, "MuunCap2MixRate_AL0", 0, path);

	this->m_Muun2MixRate[1] = GetPrivateProfileInt(section, "MuunCap2MixRate_AL1", 0, path);

	this->m_Muun2MixRate[2] = GetPrivateProfileInt(section, "MuunCap2MixRate_AL2", 0, path);

	this->m_Muun2MixRate[3] = GetPrivateProfileInt(section, "MuunCap2MixRate_AL3", 0, path);
#endif
	//
#if(CUSTOM_MIX_PET_CAP3)
	this->m_Muun3MixRate[0] = GetPrivateProfileInt(section, "MuunCap3MixRate_AL0", 0, path);

	this->m_Muun3MixRate[1] = GetPrivateProfileInt(section, "MuunCap3MixRate_AL1", 0, path);

	this->m_Muun3MixRate[2] = GetPrivateProfileInt(section, "MuunCap3MixRate_AL2", 0, path);

	this->m_Muun3MixRate[3] = GetPrivateProfileInt(section, "MuunCap3MixRate_AL3", 0, path);
#endif

#if(CUSTOM_MIX_PET_CAP4)
	this->m_Muun4MixRate[0] = GetPrivateProfileInt(section, "MuunCap4MixRate_AL0", 0, path);

	this->m_Muun4MixRate[1] = GetPrivateProfileInt(section, "MuunCap4MixRate_AL1", 0, path);

	this->m_Muun4MixRate[2] = GetPrivateProfileInt(section, "MuunCap4MixRate_AL2", 0, path);

	this->m_Muun4MixRate[3] = GetPrivateProfileInt(section, "MuunCap4MixRate_AL3", 0, path);
#endif

#if(CUSTOM_MIX_PET_CAP5)
	this->m_Muun5MixRate[0] = GetPrivateProfileInt(section, "MuunCap5MixRate_AL0", 0, path);

	this->m_Muun5MixRate[1] = GetPrivateProfileInt(section, "MuunCap5MixRate_AL1", 0, path);

	this->m_Muun5MixRate[2] = GetPrivateProfileInt(section, "MuunCap5MixRate_AL2", 0, path);

	this->m_Muun5MixRate[3] = GetPrivateProfileInt(section, "MuunCap5MixRate_AL3", 0, path);
#endif

#if(CUSTOM_MIX_PET_CAP6)
	this->m_Muun6MixRate[0] = GetPrivateProfileInt(section, "MuunCap6MixRate_AL0", 0, path);

	this->m_Muun6MixRate[1] = GetPrivateProfileInt(section, "MuunCap6MixRate_AL1", 0, path);

	this->m_Muun6MixRate[2] = GetPrivateProfileInt(section, "MuunCap6MixRate_AL2", 0, path);

	this->m_Muun6MixRate[3] = GetPrivateProfileInt(section, "MuunCap6MixRate_AL3", 0, path);
#endif


#if(CUSTOM_MIX_PET_CAP7)
	this->m_Muun7MixRate[0] = GetPrivateProfileInt(section, "MuunCap7MixRate_AL0", 0, path);

	this->m_Muun7MixRate[1] = GetPrivateProfileInt(section, "MuunCap7MixRate_AL1", 0, path);

	this->m_Muun7MixRate[2] = GetPrivateProfileInt(section, "MuunCap7MixRate_AL2", 0, path);

	this->m_Muun7MixRate[3] = GetPrivateProfileInt(section, "MuunCap7MixRate_AL3", 0, path);
#endif


#if(CUSTOM_MIX_PET_CAP8)
	this->m_Muun8MixRate[0] = GetPrivateProfileInt(section, "MuunCap8MixRate_AL0", 0, path);

	this->m_Muun8MixRate[1] = GetPrivateProfileInt(section, "MuunCap8MixRate_AL1", 0, path);

	this->m_Muun8MixRate[2] = GetPrivateProfileInt(section, "MuunCap8MixRate_AL2", 0, path);

	this->m_Muun8MixRate[3] = GetPrivateProfileInt(section, "MuunCap8MixRate_AL3", 0, path);
#endif


#if(CUSTOM_MIX_PET_CAP9)
	this->m_Muun9MixRate[0] = GetPrivateProfileInt(section, "MuunCap9MixRate_AL0", 0, path);

	this->m_Muun9MixRate[1] = GetPrivateProfileInt(section, "MuunCap9MixRate_AL1", 0, path);

	this->m_Muun9MixRate[2] = GetPrivateProfileInt(section, "MuunCap9MixRate_AL2", 0, path);

	this->m_Muun9MixRate[3] = GetPrivateProfileInt(section, "MuunCap9MixRate_AL3", 0, path);
#endif


#if(CUSTOM_MIX_PET_CAP10)
	this->m_Muun10MixRate[0] = GetPrivateProfileInt(section, "MuunCap10MixRate_AL0", 0, path);

	this->m_Muun10MixRate[1] = GetPrivateProfileInt(section, "MuunCap10MixRate_AL1", 0, path);

	this->m_Muun10MixRate[2] = GetPrivateProfileInt(section, "MuunCap10MixRate_AL2", 0, path);

	this->m_Muun10MixRate[3] = GetPrivateProfileInt(section, "MuunCap10MixRate_AL3", 0, path);
#endif

#if(CUSTOM_MIX_PET_CAP11)
	this->m_Muun11MixRate[0] = GetPrivateProfileInt(section, "MuunCap11MixRate_AL0", 0, path);

	this->m_Muun11MixRate[1] = GetPrivateProfileInt(section, "MuunCap11MixRate_AL1", 0, path);

	this->m_Muun11MixRate[2] = GetPrivateProfileInt(section, "MuunCap11MixRate_AL2", 0, path);

	this->m_Muun11MixRate[3] = GetPrivateProfileInt(section, "MuunCap11MixRate_AL3", 0, path);
#endif
...
void CServerInfo::ReadCommonInfo(char* section,char* path)
{
	...
	this->GioiHanResetTop1 = GetPrivateProfileInt(section, "GioiHanResetTop1", 0, path);
	...
	this->m_Durability_Pet = GetPrivateProfileInt(section, "Durability_Pet", 0, path);
...
void CServerInfo::ReadCustomInfo(char* section,char* path)
{
	char GameServerInfo[100] = {0};
#if(EVENT_MAPBAOTIEU)
	GetPrivateProfileString(section, "EVEN_BD_MESS1", "MESS1", this->EventBD_Mess[0], sizeof(this->EventBD_Mess[0]), path);
	GetPrivateProfileString(section, "EVEN_BD_MESS2", "MESS2", this->EventBD_Mess[1], sizeof(this->EventBD_Mess[1]), path);
	GetPrivateProfileString(section, "EVEN_BD_MESS3", "MESS3", this->EventBD_Mess[2], sizeof(this->EventBD_Mess[2]), path);

	this->BAOTIEU_NPC  = GetPrivateProfileInt(section, "BAOTIEU_NPC", 0, path);
	this->BAOTIEU_NPCX = GetPrivateProfileInt(section, "BAOTIEU_NPCX", 1, path);
	this->BAOTIEU_NPCY = GetPrivateProfileInt(section, "BAOTIEU_NPCY", 1, path);
	this->BAOTIEU_GATE = GetPrivateProfileInt(section, "BAOTIEU_GATE", 1, path);

	this->DAOTAC_NPC =  GetPrivateProfileInt(section, "DAOTAC_NPC", 0, path);
	this->DAOTAC_NPCX = GetPrivateProfileInt(section, "DAOTAC_NPCX", 1, path);
	this->DAOTAC_NPCY = GetPrivateProfileInt(section, "DAOTAC_NPCY", 1, path);
	this->DAOTAC_GATE = GetPrivateProfileInt(section, "DAOTAC_GATE", 1, path);

	this->CHUNGBD_NPC = GetPrivateProfileInt(section,  "CHUNGBD_NPC", 0, path);
	this->CHUNGBD_NPCX = GetPrivateProfileInt(section, "CHUNGBD_NPCX", 1, path);
	this->CHUNGBD_NPCY = GetPrivateProfileInt(section, "CHUNGBD_NPCY", 1, path);
	this->CHUNGBD_GATE = GetPrivateProfileInt(section, "CHUNGBD_GATE", 1, path);
#endif
#if(CHONPHEDOILAP)
	//---
	this->MoChucNangChonPhe = GetPrivateProfileInt(section, "MoChucNangChonPhe", 1, path);
#endif
#if(DROP_ITEMBAG)
...
void CServerInfo::ReadPKEventInfo()
{
	...
	GetPrivateProfileString("MESSAGES", "Msg01", "[Survivor][%s] Event starts in %d minutes", this->SurvivorMsg[0], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg02", "[Survivor][%s] Enter /survivor to join the Event", this->SurvivorMsg[1], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg03", "All Classes", this->SurvivorMsg[2], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg04", "Wizard", this->SurvivorMsg[3], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg05", "Knight", SurvivorMsg[4], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg06", "Elf", SurvivorMsg[5], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg07", "Gladiator", this->SurvivorMsg[6], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg08", "Dark Lord", this->SurvivorMsg[7], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg09", "Rage Fighter", this->SurvivorMsg[8], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg10", "The current Survivor event is not for your class", this->SurvivorMsg[9], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg11", "No Survivor event is currently opened", this->SurvivorMsg[10], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg12", "You are signed to Survivor! Good luck!", this->SurvivorMsg[11], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg13", "You are already signed for next Survivor!", this->SurvivorMsg[12], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg14", "[Survivor] Battle starts in %d minutes. Prepare yourself!", this->SurvivorMsg[13], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg15", "[Survivor] Battle has started. Save yourself!", this->SurvivorMsg[14], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg16", "[%s] killed [%s]", this->SurvivorMsg[15], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg17", "You were killed by %s", this->SurvivorMsg[16], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg18", "[Survivor] [%s] is the Survivor, and Wins!", this->SurvivorMsg[17], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg19", "[Survivor] [%s] Wins by kill count", this->SurvivorMsg[18], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg20", "[Survivor] Event ended without winner at this time", this->SurvivorMsg[19], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg21", "[Survivor] Event canceled due to lack of players", this->SurvivorMsg[20], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg22", "You cant clear PK during the Survivor event", this->SurvivorMsg[21], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	GetPrivateProfileString("MESSAGES", "Msg23", "The current Survivor event is not for your class", this->SurvivorMsg[22], sizeof(this->SurvivorMsg[0]), "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorMap = GetPrivateProfileInt("OPTIONS", "SurvivorMap", 0, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorX1 = GetPrivateProfileInt("OPTIONS", "SurvivorX1", 136, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorY1 = GetPrivateProfileInt("OPTIONS", "SurvivorY1", 123, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorX2 = GetPrivateProfileInt("OPTIONS", "SurvivorX2", 145, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorY2 = GetPrivateProfileInt("OPTIONS", "SurvivorY2", 131, "..\\Data\\Event\\PKEvent\\PKEvent.ini");

	this->SurvivorTimeLimit = GetPrivateProfileInt("OPTIONS", "TimeLimit", 5, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorTimeData = GetPrivateProfileInt("OPTIONS", "TimeDataSQL", 5, "..\\Data\\Event\\PKEvent\\PKEvent.ini");

	this->SurvivorTimeThongBaoDangKy = GetPrivateProfileInt("OPTIONS", "TimeThongBaoEvent", 5, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorTimeChuanBiBatDau = GetPrivateProfileInt("OPTIONS", "TimeChuanBiChienDau", 5, "..\\Data\\Event\\PKEvent\\PKEvent.ini");

	this->SurvivorWinnerByKillCount = GetPrivateProfileInt("OPTIONS", "WinnerByKillCount", 1, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorMinimumPlayers = GetPrivateProfileInt("OPTIONS", "MinimumPlayers", 1, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorDisableTeleport = GetPrivateProfileInt("OPTIONS", "DisableTeleport", 1, "..\\Data\\Event\\PKEvent\\PKEvent.ini");

	this->SurvivorItemByKillCharter = GetPrivateProfileInt("DropItem", "DropItem", 1, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorItemType = GetPrivateProfileInt("DropItem", "ItemType", 1, "..\\Data\\Event\\PKEvent\\PKEvent.ini");

	this->SurvivorItemIndex1 = GetPrivateProfileInt("DropItem", "ItemIndex1", 1, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorItemIndex2 = GetPrivateProfileInt("DropItem", "ItemIndex2", 1, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorItemIndex3 = GetPrivateProfileInt("DropItem", "ItemIndex3", 1, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorItemIndex4 = GetPrivateProfileInt("DropItem", "ItemIndex4", 1, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorItemIndex5 = GetPrivateProfileInt("DropItem", "ItemIndex5", 1, "..\\Data\\Event\\PKEvent\\PKEvent.ini");

	this->SurvivorWinWCoinC = GetPrivateProfileInt("PhanThuong", "WCoinC", 1, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorWinWCoinP = GetPrivateProfileInt("PhanThuong", "WCoinP", 1, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
	this->SurvivorWinThanhTuu = GetPrivateProfileInt("PhanThuong", "ThanhTuu", 1, "..\\Data\\Event\\PKEvent\\PKEvent.ini");
