...
constexpr BYTE DS_HEAD_HELPER = 0x17;
constexpr BYTE DS_HEAD_CASHSHOP = 0x18;
constexpr BYTE DS_HEAD_PCPOINT = 0x19;
constexpr BYTE DS_HEAD_LUCKY_COIN = 0x1A;
constexpr BYTE DS_HEAD_RESERVED_1B = 0x1B; // Reserved
...
constexpr BYTE DS_HEAD_LUCKY_ITEM = 0x22;
constexpr BYTE DS_HEAD_PENTAGRAM_SYSTEM = 0x23;
constexpr BYTE HEAD_SNS_DATA = 0x24;
constexpr BYTE DS_HEAD_PERSONAL_SHOP = 0x25;
constexpr BYTE DS_HEAD_EVENT_INVENTORY = 0x26;
constexpr BYTE DS_HEAD_MUUN_SYSTEM = 0x27;
constexpr BYTE DS_HEAD_GUILD_MATCHING = 0x28;
constexpr BYTE DS_HEAD_PARTY_MATCHING = 0x29;
constexpr BYTE DS_HEAD_CHARACTER_INFO_SAVE = 0x30;
constexpr BYTE DS_HEAD_INVENTORY_ITEM_SAVE = 0x31;
constexpr BYTE DS_HEAD_OPTION_DATA_SAVE = 0x33;
constexpr BYTE DS_HEAD_PET_ITEM_INFO_SAVE = 0x34;
constexpr BYTE DS_HEAD_RESET_INFO_SAVE = 0x39;
constexpr BYTE DS_HEAD_MASTER_RESET_INFO_SAVE = 0x3A;
constexpr BYTE DS_HEAD_RANKING_DUEL_SAVE = 0x3C;
constexpr BYTE DS_HEAD_RANKING_BLOOD_CASTLE_SAVE = 0x3D;
constexpr BYTE DS_HEAD_RANKING_CHAOS_CASTLE_SAVE = 0x3E;
constexpr BYTE DS_HEAD_RANKING_DEVIL_SQUARE_SAVE = 0x3F;
constexpr BYTE DS_HEAD_RANKING_ILLUSION_TEMPLE_SAVE = 0x40;
constexpr BYTE DS_HEAD_CREATION_CARD_SAVE = 0x42;
constexpr BYTE DS_HEAD_CRYWOLF_INFO_SAVE = 0x49;
constexpr BYTE DS_HEAD_SNS_DATA_SAVE = 0x4E;
constexpr BYTE DS_HEAD_CUSTOM_MONSTER_REWARD_SAVE = 0x52;
constexpr BYTE DS_HEAD_RANKING_CUSTOM_ARENA_SAVE = 0x55;
constexpr BYTE DS_HEAD_RANKING_TVT_EVENT_SAVE = 0x56;
constexpr BYTE DS_HEAD_CONNECT_CHARACTER = 0x70;
constexpr BYTE DS_HEAD_DISCONNECT_CHARACTER = 0x71;
constexpr BYTE HEAD_GLOBAL_WHISPER = 0x72;
constexpr BYTE HEAD_GLOBAL_WHISPER_ECHO = 0x73;
constexpr BYTE DS_HEAD_RANKING_KING_GUILD_SAVE = 0x74;
constexpr BYTE DS_HEAD_RANKING_KING_PLAYER_SAVE = 0x75;
constexpr BYTE HEAD_GLOBAL_ITEM_POST = 0x78;
constexpr BYTE HEAD_CASTLE_SIEGE = 0x80;
constexpr BYTE DS_HEAD_CASTLE_INIT_DATA = 0x81;
constexpr BYTE DS_HEAD_CASTLE_NPC_INFO = 0x82;
constexpr BYTE DS_HEAD_CASTLE_ALL_GUILD_MARK = 0x83;
constexpr BYTE DS_HEAD_CASTLE_FIRST_CREATE_NPC = 0x84;
constexpr BYTE DS_HEAD_CASTLE_CALC_REG_GUILD = 0x85;
constexpr BYTE DS_HEAD_CASTLE_GUILD_UNION_INFO = 0x86;
constexpr BYTE DS_HEAD_CASTLE_SAVE_GUILD_INFO = 0x87;
constexpr BYTE DS_HEAD_CASTLE_LOAD_GUILD_INFO = 0x88;
constexpr BYTE DS_HEAD_CASTLE_NPC_UPDATE = 0x89;
constexpr BYTE DS_HEAD_CUSTOM_PROTOCOL = 0xB0; // Custom
constexpr BYTE DS_HEAD_EXDB_PROTOCOL = 0xE0;
constexpr BYTE DS_HEAD_CONNECT_SERVER = 0xE1;
constexpr BYTE DS_HEAD_MARRY_INFO_SAVE = 0xF0;
constexpr BYTE DS_HEAD_CUSTOM_QUEST = 0xF1;
constexpr BYTE DS_HEAD_CUSTOM_QUEST_SAVE = 0xF2;
constexpr BYTE DS_HEAD_SET_COIN = 0xF3;
constexpr BYTE DS_HEAD_CUSTOM_RANKING = 0xF4;
constexpr BYTE DS_HEAD_ATTACK_RESUME = 0xF5;
constexpr BYTE DS_HEAD_ATTACK_RESUME_SAVE = 0xF6;
constexpr BYTE DS_HEAD_CUSTOM_NPC_QUEST = 0xF7;
constexpr BYTE DS_HEAD_CUSTOM_GHRS = 0xF8;
constexpr BYTE DS_HEAD_BOT_INFO = 0xF9;
constexpr BYTE DS_HEAD_CUSTOM_EXTENSIONS = 0xD9;
...
//**********************************************
constexpr BYTE DS_SUB_GENS_SYSTEM_INSERT		= 0x00;
constexpr BYTE DS_SUB_GENS_SYSTEM_DELETE		= 0x01;
constexpr BYTE DS_SUB_GENS_SYSTEM_MEMBER		= 0x02;
constexpr BYTE DS_SUB_GENS_SYSTEM_UPDATE		= 0x03;
constexpr BYTE DS_SUB_GENS_SYSTEM_REWARD		= 0x04;
constexpr BYTE DS_SUB_GENS_SYSTEM_REWARD_SAVE	= 0x30;
constexpr BYTE DS_SUB_GENS_SYSTEM_CREATE		= 0x70;
//**********************************************
// Quest SubHeads (0x0C)
//**********************************************
...
//**********************************************
constexpr BYTE DS_SUB_COMMAND_RESET = 0x00;
constexpr BYTE DS_SUB_COMMAND_MASTER_RESET = 0x01;
constexpr BYTE DS_SUB_COMMAND_MARRY = 0x02;
constexpr BYTE DS_SUB_COMMAND_REWARD = 0x03;
constexpr BYTE DS_SUB_COMMAND_REWARD_ALL = 0x04;
constexpr BYTE DS_SUB_COMMAND_RENAME = 0x05;
constexpr BYTE DS_SUB_COMMAND_BLOCK_ACCOUNT = 0x06;
constexpr BYTE DS_SUB_COMMAND_BLOCK_CHARACTER = 0x07;
constexpr BYTE DS_SUB_COMMAND_GIFT = 0x08;
constexpr BYTE DS_SUB_COMMAND_TOP = 0x09;
//**********************************************
// Quest World SubHeads (0x10)
//**********************************************
constexpr BYTE DS_SUB_QUEST_WORLD_LOAD = 0x00;
constexpr BYTE DS_SUB_QUEST_WORLD_SAVE = 0x30;
//**********************************************
// MuRummy SubHeads (0x12)
//**********************************************
constexpr BYTE DS_SUB_MURUMMY_LOAD = 0x00;
constexpr BYTE DS_SUB_MURUMMY_INSERT = 0x30;
constexpr BYTE DS_SUB_MURUMMY_UPDATE = 0x31;
constexpr BYTE DS_SUB_MURUMMY_SCORE_UPDATE = 0x32;
constexpr BYTE DS_SUB_MURUMMY_DELETE = 0x33;
constexpr BYTE DS_SUB_MURUMMY_SLOT_UPDATE = 0x34;
constexpr BYTE DS_SUB_MURUMMY_INFO_UPDATE = 0x35;
//**********************************************
// Helper SubHeads (0x17)
//**********************************************
constexpr BYTE DS_SUB_HELPER_LOAD = 0x00;
constexpr BYTE DS_SUB_HELPER_SAVE = 0x30;
//**********************************************
// CashShop SubHeads (0x18)
//**********************************************
constexpr BYTE DS_SUB_CASHSHOP_POINT = 0x00;
constexpr BYTE DS_SUB_CASHSHOP_ITEM_BUY = 0x01;
constexpr BYTE DS_SUB_CASHSHOP_ITEM_GIFT = 0x02;
constexpr BYTE DS_SUB_CASHSHOP_ITEM_LIST = 0x03;
constexpr BYTE DS_SUB_CASHSHOP_ITEM_USE = 0x04;
constexpr BYTE DS_SUB_CASHSHOP_PERIODIC_ITEM = 0x05;
constexpr BYTE DS_SUB_CASHSHOP_RECIEVE_POINT = 0x06;
constexpr BYTE DS_SUB_CASHSHOP_ADD_POINT_SAVE = 0x30;
constexpr BYTE DS_SUB_CASHSHOP_SUB_POINT_SAVE = 0x31;
constexpr BYTE DS_SUB_CASHSHOP_INSERT_ITEM_SAVE = 0x32;
constexpr BYTE DS_SUB_CASHSHOP_DELETE_ITEM_SAVE = 0x33;
constexpr BYTE DS_SUB_CASHSHOP_PERIODIC_ITEM_SAVE = 0x34;
//**********************************************
// PC Point SubHeads (0x19)
//**********************************************
constexpr BYTE DS_SUB_PCPOINT_POINT = 0x00;
constexpr BYTE DS_SUB_PCPOINT_ITEM_BUY = 0x01;
constexpr BYTE DS_SUB_PCPOINT_RECIEVE_POINT = 0x02;
constexpr BYTE DS_SUB_PCPOINT_ADD_POINT_SAVE = 0x30;
constexpr BYTE DS_SUB_PCPOINT_SUB_POINT_SAVE = 0x31;
//**********************************************
// Lucky Coin SubHeads (0x1A)
//**********************************************
constexpr BYTE DS_SUB_LUCKY_COIN_COUNT = 0x00;
constexpr BYTE DS_SUB_LUCKY_COIN_REGISTER = 0x01;
constexpr BYTE DS_SUB_LUCKY_COIN_EXCHANGE = 0x02;
constexpr BYTE DS_SUB_LUCKY_COIN_ADD_COUNT_SAVE = 0x30;
constexpr BYTE DS_SUB_LUCKY_COIN_SUB_COUNT_SAVE = 0x31;
//**********************************************
// Reserved SubHeads (0x1B)
//**********************************************
constexpr BYTE DS_SUB_RESERVED_1B = 0x00;
//**********************************************
// Lucky Item SubHeads (0x22)
//**********************************************
constexpr BYTE DS_SUB_LUCKY_ITEM_LOAD = 0x00;
constexpr BYTE DS_SUB_LUCKY_ITEM_SAVE = 0x4A;
//**********************************************
// Pentagram System SubHeads (0x23)
//**********************************************
constexpr BYTE DS_SUB_PENTAGRAM_JEWEL_INFO = 0x00;
constexpr BYTE DS_SUB_PENTAGRAM_JEWEL_INFO_SAVE = 0x30;
constexpr BYTE DS_SUB_PENTAGRAM_JEWEL_INSERT_SAVE = 0x31;
constexpr BYTE DS_SUB_PENTAGRAM_JEWEL_DELETE_SAVE = 0x32;
//**********************************************
// Personal Shop SubHeads (0x25)
//**********************************************
constexpr BYTE DS_SUB_PSHOP_ITEM_VALUE = 0x00;
constexpr BYTE DS_SUB_PSHOP_ITEM_VALUE_SAVE = 0x30;
constexpr BYTE DS_SUB_PSHOP_ITEM_VALUE_INSERT = 0x31;
constexpr BYTE DS_SUB_PSHOP_ITEM_VALUE_DELETE = 0x32;
//**********************************************
// Event Inventory SubHeads (0x26)
//**********************************************
constexpr BYTE DS_SUB_EVENT_INVENTORY = 0x00;
constexpr BYTE DS_SUB_EVENT_INVENTORY_SAVE = 0x30;
//**********************************************
// Muun System SubHeads (0x27)
//**********************************************
constexpr BYTE DS_SUB_MUUN_INVENTORY = 0x00;
constexpr BYTE DS_SUB_MUUN_INVENTORY_SAVE = 0x30;
//**********************************************
// Guild Matching SubHeads (0x28)
//**********************************************
constexpr BYTE DS_SUB_GUILD_MATCHING_LIST = 0x00;
constexpr BYTE DS_SUB_GUILD_MATCHING_LIST_SEARCH = 0x01;
constexpr BYTE DS_SUB_GUILD_MATCHING_INSERT = 0x02;
constexpr BYTE DS_SUB_GUILD_MATCHING_CANCEL = 0x03;
constexpr BYTE DS_SUB_GUILD_MATCHING_JOIN_INSERT = 0x04;
constexpr BYTE DS_SUB_GUILD_MATCHING_JOIN_CANCEL = 0x05;
constexpr BYTE DS_SUB_GUILD_MATCHING_JOIN_ACCEPT = 0x06;
constexpr BYTE DS_SUB_GUILD_MATCHING_JOIN_LIST = 0x07;
constexpr BYTE DS_SUB_GUILD_MATCHING_JOIN_INFO = 0x08;
constexpr BYTE DS_SUB_GUILD_MATCHING_INSERT_SAVE = 0x30;
//**********************************************
// Party Matching SubHeads (0x29)
//**********************************************
constexpr BYTE DS_SUB_PARTY_MATCHING_INSERT = 0x00;
constexpr BYTE DS_SUB_PARTY_MATCHING_LIST = 0x01;
constexpr BYTE DS_SUB_PARTY_MATCHING_JOIN_INSERT = 0x02;
constexpr BYTE DS_SUB_PARTY_MATCHING_JOIN_INFO = 0x03;
constexpr BYTE DS_SUB_PARTY_MATCHING_JOIN_LIST = 0x04;
constexpr BYTE DS_SUB_PARTY_MATCHING_JOIN_ACCEPT = 0x05;
constexpr BYTE DS_SUB_PARTY_MATCHING_JOIN_CANCEL = 0x06;
constexpr BYTE DS_SUB_PARTY_MATCHING_INSERT_SAVE = 0x30;
//**********************************************
...
constexpr BYTE DS_SUB_CASTLE_GUILD_MARK_RESET = 0x11;
constexpr BYTE DS_SUB_CASTLE_GUILD_GIVEUP = 0x12;
constexpr BYTE DS_SUB_CASTLE_NPC_REMOVE = 0x16;
constexpr BYTE DS_SUB_CASTLE_STATE_SYNC = 0x17;
constexpr BYTE DS_SUB_CASTLE_TRIBUTE_MONEY = 0x18;
constexpr BYTE DS_SUB_CASTLE_RESET_TAX_INFO = 0x19;
constexpr BYTE DS_SUB_CASTLE_RESET_SIEGE_GUILD = 0x1A;
constexpr BYTE DS_SUB_CASTLE_RESET_REG_INFO = 0x1B;
//**********************************************
// Custom SubHeads (0xB0)
//**********************************************
#if (SACHTHUOCTINH_NEW)
constexpr BYTE DS_SUB_SACH_THUOC_TINH_LOAD = 0x03;
constexpr BYTE DS_SUB_SACH_THUOC_TINH_SAVE = 0x04;
#endif
#if (MOCNAP == 1)
constexpr BYTE DS_SUB_MOCNAP_LOAD = 0x13;
constexpr BYTE DS_SUB_MOCNAP_SAVE = 0x14;
#endif
//**********************************************
// Custom NPC Quest SubHeads (0xF7)
//**********************************************
constexpr BYTE DS_SUB_CUSTOM_NPC_QUEST_INFO = 0x00;
constexpr BYTE DS_SUB_CUSTOM_NPC_QUEST_SAVE = 0x01;
constexpr BYTE DS_SUB_CUSTOM_NPC_QUEST_MONSTER_COUNT_SAVE = 0x02;
constexpr BYTE DS_SUB_CUSTOM_JEWEL_BANK = 0x04;
constexpr BYTE DS_SUB_CUSTOM_JEWEL_BANK_INFO = 0x05;
//**********************************************
// Custom Extensions (0xD9)
//**********************************************
constexpr BYTE DS_SUB_SKIN_GET_LIST = 0x01;
constexpr BYTE DS_SUB_SKIN_SAVE = 0x02;
constexpr BYTE DS_SUB_THE_GIFT_SAVE = 0x07;
constexpr BYTE DS_SUB_CHANGE_PASSWORD_SAVE = 0x09;
constexpr BYTE DS_SUB_CHARACTER_RANKING = 0x17;
constexpr BYTE DS_SUB_BUFFPHE_LOAD = 0x18;
constexpr BYTE DS_SUB_BUFFPHE_TOP_INFO = 0x19;
