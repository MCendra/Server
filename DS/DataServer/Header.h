...
#define CUSTOMTITLESYSTEM		true
#define CUSTOMASCENSIONSYSTEM	true
#define ANCIENTBATTLEFIELDEVENT	true
#define GUILDBOSSEVENT			true
#define ENABLECUSTOMRANKING		false
#define NEWRANKING				true
#define TOP1RESETLIMIT			true
#define ENABLECUSTOMQUEST		true 
#define ANCIENTBATTLEFIELDEVENT	true
#define CUSTOMELEMENTALBOOK		true
#define CUSTOMFACTIONSYSTEM		true
#define CUSTOMSOULRINGEFFECT	true
#define ENDLESSTOWEREVENT		true
#define CUSTOMFLAGSKIN			true
